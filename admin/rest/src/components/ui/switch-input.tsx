...
const SwitchInput = ({ control, label, name, errors, disabled, ...rest }: Props) => {
      ...
      <Controller
        ...
        render={({ field: { onChange, value } }) => (
          <Switch
            ...
            } relative inline-flex items-center h-6 rounded-full w-11 focus:outline-none ${disabled ? 'bg-[#EEF1F4] cursor-not-allowed' : ''}`}
            dir="ltr"
          >
